const queryList = {
  ...
  UPDATE_BOOK: `UPDATE public.book SET title=COALESCE($1, title), authorid=COALESCE($2, authorid), publisheddate=COALESCE($3, publisheddate) WHERE bookid=$4`,
  DELETE_BOOK: `DELETE FROM public.book WHERE bookid=$1`,
};
